...
- **Decision:** `TESTING_STRATEGY.md` (repo root) is the single source of truth, prescriptive and
...
- **Evolve later:** deferred, trigger-based items live in `TESTING_STRATEGY.md` §11 (idempotent
