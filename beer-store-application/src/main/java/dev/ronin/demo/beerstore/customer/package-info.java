 ...
 * everything under {@code internal} is an implementation detail, including the {@code Customer}
 * aggregate itself. Its inbound REST adapter also uses the (Modulith-excluded) {@code platform}
